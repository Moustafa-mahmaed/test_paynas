...
export const fontFamilyStyles = props => {
  const {font, bold, medium} = props;

  return {
    fontFamily:
      font ||
      (bold ? getFonts().bold : medium ? getFonts().medium : getFonts().normal),
    fontWeight:
...
export const elevationStyles = props => {
  ...
  if (elevation) {
    if (Platform.OS === 'ios') {
      styles.borderTopWidth = elevation - 2;
      styles.borderBottomWidth = elevation - 2;
      styles.borderLeftWidth = elevation - 2;
      styles.borderRightWidth = elevation - 2;
      styles.borderBottomColor = '#e6e6e6';
      styles.borderTopColor = '#e6e6e6';
      styles.borderLeftColor = '#e6e6e6';
      styles.borderRightColor = '#e6e6e6';
      ...
      //   height: 2,
      // };
      // styles.shadowOpacity = 0.25;
      // styles.shadowRadius = 3.84;
    } else {
